...
<svelte:head>
	...
	<meta name="description" content="Privacy policy for ed3d.net." />
	...
	<meta name="twitter:description" content="Privacy policy for ed3d.net." />
</svelte:head>

<div class="long-form-content">
	<h1 class="text-2xl">ed3d.net Privacy Policy</h1>
	<p>
		<em>Last updated: 14 October 2023</em>
	</p>
	<p>
		Privacy contact: <a href="mailto:ed+privacy@ed3d.net">ed+privacy@ed3d.net</a>
	</p>
