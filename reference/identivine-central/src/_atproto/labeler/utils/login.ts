...
import { type AtpSessionData, CredentialManager, XRPC } from "@atcute/client";
...
export async function loginAgent({
  pds,
  ...credentials
}: LoginCredentials): Promise<{ agent: XRPC; session: AtpSessionData }> {
